 ...
 */
export function createOptionsHandler(headers: HeadersInit): ActionHandler<null> {
 ...
 */
export function createActionRoutes(handlers: ActionRouteHandlers, headers: HeadersInit) {
 ...
 */
function createActionHandler(handler: ActionHandlerFn<any>, headers: HeadersInit): ActionHandler<any> {
